...
public class ClientHandler implements Runnable{
    ...
    static {
        match.put(".html", "text/html");
        match.put(".css", "text/css");
        match.put(".js", "application/javascript");
        match.put(".png", "image/png");
        match.put(".gif", "image/gif");
        match.put(".jpg", "image/jpg");
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (file.exists() && file.isFile()) {
                ...
                if (substring !=null){
                httpResponse.putHeader("Content-Type", match.get(substring));
                httpResponse.putHeader("Content-Length", String.valueOf(file.length()));
